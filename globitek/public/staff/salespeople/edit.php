...
if(is_post_request()) {
  ...
  if(isset($_POST['first_name'])) { $salesperson['first_name'] = test_input($_POST['first_name']); }
  if(isset($_POST['last_name'])) { $salesperson['last_name'] = test_input($_POST['last_name']); }
  if(isset($_POST['phone'])) { $salesperson['phone'] = test_input($_POST['phone']); }
  if(isset($_POST['email'])) { $salesperson['email'] = test_input($_POST['email']); }
